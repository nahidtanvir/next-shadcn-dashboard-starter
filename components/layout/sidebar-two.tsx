...
import Nav from '@/components/sidebar-two-nav'
...
export default function SidebarTwo({
  ...
  return (
    <aside
      className={cn(
        `border-r-2 border-r-muted transition-[width] md:bottom-0 md:right-auto md:h-svh ${isCollapsed ? 'md:w-14' : 'md:w-64'}`,
        className
      )}
    >
      {/* Overlay in mobile */}
      ...
      <Layout>
        ...
        <Button
          ...
          size='icon'
          variant='outline'
          className='absolute -right-5 top-1/2 hidden rounded-full md:inline-flex z-50'
        >
          <IconChevronsLeft
            stroke={1.5}
